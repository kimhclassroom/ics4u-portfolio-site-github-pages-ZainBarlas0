...
public class LoginPage extends JPanel {
    ...
    private  JLabel message= new JLabel();
       ...
       springLayout.putConstraint(SpringLayout.WEST, message,100, SpringLayout.WEST,this);
        springLayout.putConstraint(SpringLayout.NORTH, message,175 , SpringLayout.NORTH,this);
    ...
    //getting the name entered in the text field
    public String getName(){
        return enterName.getText().trim();
    }

    //getting hte password entered in the text field
